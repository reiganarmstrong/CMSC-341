...
string File::key() const { return m_name; }
unsigned int File::diskBlock() const { return m_diskBlock; }
void File::setKey(string key) { m_name = key; }
void File::setDiskBlock(unsigned int diskBlock) { m_diskBlock = diskBlock; }
...
bool operator==(const File& lhs, const File& rhs) {
    return ((lhs.m_name == rhs.m_name) &&
            (lhs.m_diskBlock == rhs.m_diskBlock));
}
